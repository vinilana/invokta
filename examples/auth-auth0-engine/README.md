...
| `AUTH0_MCP_CHALLENGE_SCOPES` | no | Ordered scopes serialized into the 401 Bearer challenge. Requires `AUTH0_MCP_RESOURCE` |
...
```sh
yarn workspace @invokta/example-auth-auth0 deploy:inspect-oauth --url https://engine.example.com/mcp
```
