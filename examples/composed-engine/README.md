...
```sh
yarn workspace @invokta/example-composed devtools
yarn workspace @invokta/example-composed devtools:doctor
yarn workspace @invokta/example-composed check:mcp
```
