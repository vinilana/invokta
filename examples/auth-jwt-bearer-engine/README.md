...
```sh
yarn workspace @invokta/example-auth-jwt-bearer devtools
yarn workspace @invokta/example-auth-jwt-bearer devtools:doctor
yarn workspace @invokta/example-auth-jwt-bearer check:mcp
```
