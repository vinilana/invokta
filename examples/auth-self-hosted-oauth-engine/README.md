...
```sh
yarn workspace @invokta/example-auth-self-hosted-oauth devtools
yarn workspace @invokta/example-auth-self-hosted-oauth devtools:doctor
yarn workspace @invokta/example-auth-self-hosted-oauth check:mcp
```
