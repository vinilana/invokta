...
| `@invokta/client-config` | Detect supported MCP clients and change their configuration under a named safety contract | [Client configuration reference](/reference/client-config/) |
...
| `@invokta/console` | Manage every installed Action Engine from a local web console | [Console reference](/reference/console/) |
