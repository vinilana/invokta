---
title: Installation
description: Install Invokta and choose how applications, CLIs, and MCP-compatible agents reach your Action Engine.
---
...
[`CONTRIBUTING.md`](https://github.com/vinilana/invokta/blob/main/CONTRIBUTING.md)
