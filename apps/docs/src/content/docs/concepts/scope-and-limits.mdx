...
| Dependencies | Typed connector definitions plus factory- and closure-friendly contracts | Ports, outbound connector implementations, lifecycle, and composition |
