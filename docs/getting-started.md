...
input and output fields plus the complete JSON Schemas, invokes capabilities
from a schema-seeded editor while showing the raw MCP exchange, follows a live
